...
export default function Navbar() {
  ...
  return (
    <nav className="w-full mx-auto fixed top-0 z-50 bg-red-600">
      <div className="w-full flex justify-between p-3 h-full items-center sm:w-4/5 md:w-4/5 lg:w-3/5 mx-auto">
        <div className="font-montserrat tracking-wide">
          <p className="font-semibold text-lg lg:text-base text-white">CANAVARO</p>
        </div>
        {orderList.length > 0 && (
          <div className="rounded-lg p-2 px-3   bg-white hover:bg-red-500  hover:-translate-y-1 transition-all duration-500">
            {loader ?
              <ColorRing
                visible={true}
                height="20"
