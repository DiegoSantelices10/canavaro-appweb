...
export default function sectionCombos() {
	return (
		<Element name="combos" className="p-3 w-full  element">
			...
			<div className="bg-black bg-opacity-80 w-full lg:w-4/5 mx-auto text-white grid lg:grid-cols-2 gap-5 content-center py-7">
				<div>
					<h1 className="col-span-2 font-bold text-lg text-center">Combo 1</h1>
					<p className="text-white text-center">1/2 Jamon</p>
					<p className="text-white text-center">1/2 Napolitana</p>
				</div>
				<div>
					<h1 className="col-span-2 font-bold text-lg text-center">Combo 2</h1>
				...
				<div>
					<h1 className="col-span-2 font-bold text-lg text-center">Combo 3</h1>
