                ...
                return (
                  <div key={producto._id}>
                    <div className="text-center">
                      <p
                        className="text-2xl font-montserrat text-white text-center font-medium "
                      >
                        {producto.nombre}
                      </p>
                      <p className="text-sm  md:text-sm lg:text-base font-montserrat text-zinc-300 px-3">{producto.descripcion}</p>
                      <p className="text-2xl font-montserrat text-white font-light pt-2">${producto.precio}</p>
                    </div>
