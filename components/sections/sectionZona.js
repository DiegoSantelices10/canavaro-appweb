  ...
  return (
    <div className=" bg-zinc-900 w-full">
      <div className="relative p-2 h-full  
        ...
        <hr className="py-2" />
        <div>
          <div className=" w-full lg:w-4/5 mx-auto text-white md:flex md:justify-center  gap-5 content-center py-5 ">
            <div className="text-center grid gap-10 font-poppins">
              <div>
